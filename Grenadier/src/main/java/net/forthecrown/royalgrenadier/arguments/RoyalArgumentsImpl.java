...
public class RoyalArgumentsImpl {
    ...
    public static void init(){
        ...
        register(ByteArgumentImpl.class,            ByteArgumentImpl::getHandle,                true);
        register(ShortArgumentImpl.class,           ShortArgumentImpl::getHandle,               true);
    ...
    public static @NotNull ArgumentType<?> getNMS(ArgumentType<?> type){
        ...
        //ScoreHolderArgument seems to be a works-for-all kind of thing, except not really
